...
const products = [
    ...
    { id: 2, name: '商品B', price: 700 },
    { id: 3, name: '商品C', price: 1200 },
    ...
    products.forEach(p => {
        ...
        (discounted > 0 ? `<div class="price">¥${p.price} → <span class="price discounted">¥${discountedPrice}</span></div>`
    ...
    const discounted = product.price - current;
    document.getElementById('selectedProductInfo').innerHTML =
